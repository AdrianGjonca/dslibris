...
App::App()
{
	//TODO Why is this necassary? Shouldn't we emulate asif on real hardware???
	/*
	melonds = false;
	...
	*/
	...
	//TODO Why did you (Ray H.) go with this route? Old worked perfectly fine.
	//Reverted to help merging.
	/*
...
static inline bool book_title_lessthan(Book* a, Book* b)
{
	...
	while (pmMainLoop())
	{
		...
		switch (mode) {
			case APP_MODE_BROWSER:
				//TODO rename this inline with others
				browser_handleevent();
...
//TODO Is this deprecated? Should we remove it?
